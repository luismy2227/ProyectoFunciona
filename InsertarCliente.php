    ...
    <body data-spy="scroll" data-target=".bs-docs-sidebar">
        ...
        <section id="maincontent">
            <div class="container">
                ...
                <div class="validation"></div>
                 <input type="text" class="form-control" name="text_UserPassword" id="text_UserPassword" placeholder="Ingrese el Password"  data-rule="minlen:4" data-msg="Porfavor ingrese Identidad" />
                <div class="validation"></div>
